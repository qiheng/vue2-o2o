<template>
    ...
    <div class="order-detail" v-cloak>
        ...
        <div class="panel-nobrd sure-order-list">
            <a class="panel-chunk lh-22" :href="'shop-detail.html?shopId='+orderInfo.shop.shopId">
            ...
            <div v-if="!isBook" class="panel-chunk">
                ...
                <ul class="lh-22 ptb5">
                    ...
                    <li>
                        <span class="pull-right emb-red">-&yen;{{ orderInfo.goodsAllDiscount | toFixed }}</span>
...
<script>
    export default {
        ...
        created () {
            ...
            // 初始化订单详情信息
            _A.getOrdersViewData({ordersId: query.ordersId}, function (orderDetail) {
                _this.orderInfo = orderDetail;
            },function (result) {

                if (result.status !== -91) {
                    layer.msg(result.msg, {shift: 0});
                    return false;
                }
...
//				});
                ...
                layer.open({
                    ...
                    yes: function (index, layerEl) {
                        ...
                        _A.cancelOrdersData({ordersId: ordersId}, function () {
                            //_this.hideBtn(ev)
                            layer.msg('取消成功', {shift:0}, function () {
        ...
        computed: {
            // 商品外送类型
            isSPWS () {
                return this.orderInfo.shopTypeId == shopTypeId.jsws;
            },
            ...
            // 到店类型
            isDDXF () {
                return this.orderInfo.shop.shopTypeId == shopTypeId.ddxf;
            },
            // 到店且是预约
            isBook () {
